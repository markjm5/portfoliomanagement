...
excel_file_path = '/Trading_Excel_Files/03_Leading_Indicators/019_Temp.xlsm'
...
countries = ['Global','US','EuroArea','China','France','Germany','UK','India','Australia'
            ,'Ireland','Italy','Japan','Brazil','Russia','Spain']
